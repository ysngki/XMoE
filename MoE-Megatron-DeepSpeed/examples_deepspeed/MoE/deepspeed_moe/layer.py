...
class MoE(torch.nn.Module):
    ...
    def forward(self, hidden_states, used_token=None, now_training_process=None):
        """ MoE forward
        ...
        return output, self.deepspeed_moe.l_aux, self.deepspeed_moe.exp_counts, self.deepspeed_moe.gate_info
